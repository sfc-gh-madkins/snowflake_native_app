...
st.write(f'{session.get_current_role()}')
st.write(f'{session.get_current_database()}')
st.write(f'{session.get_current_schema()}')
st.write(f'{session.get_current_warehouse()}')
st.write(f'{session.sql('SHOW DATABASES').collect()}')
